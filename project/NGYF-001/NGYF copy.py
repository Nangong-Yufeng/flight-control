...
def goto_test(loop, drone, goto_item):
    loop.run_until_complete(goto_test_drone(drone, goto_item))



async def goto_test_drone(drone:System, goto_item):
    print('设置参数为1m')
